...
public class Brand implements Serializable {
    ...
    private Integer clothingCommentCount;
    ...
    public Integer getClothingCommentCount() {
        return clothingCommentCount;
    }

    public void setClothingCommentCount(Integer clothingCommentCount) {
        this.clothingCommentCount = clothingCommentCount;
    }
    ...
    public String toString() {
        ...
        sb.append(", clothingCommentCount=").append(clothingCommentCount);
