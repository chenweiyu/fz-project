...
public class Clothing implements Serializable {
    ...
    public Long getClothingAttributeCategoryId() {
        return clothingAttributeCategoryId;
    }

    public void setClothingAttributeCategoryId(Long clothingAttributeCategoryId) {
        this.clothingAttributeCategoryId = clothingAttributeCategoryId;
    }
    ...
    public String getClothingCategoryName() {
        return clothingCategoryName;
    }

    public void setClothingCategoryName(String clothingCategoryName) {
        this.clothingCategoryName = clothingCategoryName;
    }
    ...
    public String toString() {
        ...
        sb.append(", clothingAttributeCategoryId=").append(clothingAttributeCategoryId);
        ...
        sb.append(", clothingCategoryName=").append(clothingCategoryName);
