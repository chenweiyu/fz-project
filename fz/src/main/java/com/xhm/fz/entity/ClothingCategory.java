...
public class ClothingCategory implements Serializable {
    ...
    public String getClothingUnit() {
        return clothingUnit;
    }

    public void setClothingUnit(String clothingUnit) {
        this.clothingUnit = clothingUnit;
    }
    ...
    public String toString() {
        ...
        sb.append(", clothingUnit=").append(clothingUnit);
